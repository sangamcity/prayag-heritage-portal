...
class Image(models.Model):  
    tourism_place = models.ForeignKey('TourismPlaces.TourismPlace', related_name="image_of", on_delete=models.CASCADE, null=True, blank=True)
...
class Video(models.Model):
    tourism_place   = models.ForeignKey('TourismPlaces.TourismPlace', related_name="video_of", on_delete=models.CASCADE, null=True, blank=True)
    name            = models.CharField(max_length=200, null=True, blank=True)
    slug            = models.SlugField(unique=True,null=True, blank=True)
...
class TourismPlace(models.Model):
    video       = models.ForeignKey(Video, related_name="video_for", on_delete=models.SET_NULL, null=True, blank=True)
    image       = models.ForeignKey(Image, related_name="image_for", null=True, on_delete=models.SET_NULL, blank=True)
    name 	    = models.CharField(max_length=200, null=True, blank=True)
    slug        = models.SlugField(unique=True,null=True, blank=True)
...
class Review(models.Model):
    tourism_place = models.ForeignKey('TourismPlaces.TourismPlace', related_name="review_of", on_delete=models.CASCADE, null=True, blank=True)
    user          = models.ForeignKey(User, related_name="review_by", null=True, on_delete=models.CASCADE, blank=True)
